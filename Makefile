...
#    Updated: 2024/01/22 11:42:23 by apereira         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c parser/parser.c parser/map.c parser/parser_utils.c parser/extract.c free.c error.c utils.c events.c math.c distance.c drawing.c drawing_aux.c moves.c
